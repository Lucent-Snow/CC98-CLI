...
| 方向二：TUI 功能接入 | 83% | ✅ 核心完成，P2 待做 |
| 方向三：产品打磨 | 50% | 🔄 交互统一完成，体验继续打磨 |
| WebVPN 支持 | ✅ | 非校园网访问已实现 |
...
| 功能 | 状态 | 说明 |
|------|------|------|
| 完整的 Vim 键位支持 | ✅ | 已统一，见下方详细说明 |
| 弹窗交互统一 | ✅ | 任意键关闭帮助，/ 关闭搜索，o 关闭菜单，u 关闭用户 |
| 搜索上下文敏感 | ✅ | 版面内搜索自动限定范围 |
| 快捷键自定义 | ❌ | 未开始 |
| 帮助文档完善 | ✅ | 帮助弹窗已更新 |
...
| 导航重构 | ✅ | 删除“更多”，内容分散到“我的”和“收藏” |
| Overview 优化 | ✅ | 显示真实数据，未读数红色高亮 |
| 右栏精简 | ✅ | 删除快捷键提示，只显示上下文信息 |
| 状态栏统一 | ✅ | 快捷键提示唯一出口 |
